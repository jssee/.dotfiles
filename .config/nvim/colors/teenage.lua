-- Name:         teenage
-- Description:  A colorscheme inspired by teengage.engineering
-- Author:       Jesse <jsshoyos@gmail.com>
-- Maintainer:   Jesse <jsshoyos@gmail.com>

-- Clear hlgroups and set colors_name {{{
vim.cmd.hi "clear"
vim.g.colors_name = "teenage"
-- }}}
...
if vim.go.bg == 'dark' then
  ...
  c_aqua           = '#3b8f84'
  c_turquoise      = '#29647a'
  c_flashlight     = '#719AB6' -- adjusted for contrast
  c_skyblue        = '#4c99d4'
  c_cerulean       = '#3c70b4'
  c_lavender       = '#9d7bca'
  c_purple         = '#8b71c7'
